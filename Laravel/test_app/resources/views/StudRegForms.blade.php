            ...
            <div class="page-horizontal-sidebar hide">
                <div id="horizontal-sidebar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active"><a href="#" data-hover="dropdown" class="dropdown-toggle"><i class="icon-envelope-open"></i><span class="menu-title">Email</span></a>
                            <ul class="dropdown-menu in">
                                <li class="active"><a href="email_inbox.html"><span class="submenu-title">Inbox</span></a></li>
            ...
            <div class="wrapper row-offcanvas row-offcanvas-left"><!--BEGIN SIDEBAR-->
                <aside class="page-sidebar sidebar-offcanvas">
                    <section class="sidebar">
                        <ul class="sidebar-menu">
                            ...
                            <li><a href="widgets.html"><i class="icon-rocket"></i><span class="sidebar-text">Widgets</span></a></li>
                            ...
                            <li class="active"><a href="#"><i class="icon-envelope-open"></i><span class="sidebar-text">Email</span></a>
                                <ul class="nav nav-second-level in">
                                    <li class="active"><a href="email_inbox.html">Inbox</a></li>
                ...
                <div class="content">
                    <section class="content-header">
                        <h1 class="pull-left">Inbox<small>Header small text goes here...</small></h1>
                    ...
                    <section class="main-content">
                        <div class="row">
                            <div class="col-md-3 col-sm-3">
                                <form action="#">
                                    <div class="input-icon right"><i class="icon-magnifier"></i><input type="email" placeholder="Search email" class="bg-white input-no-border bg-white form-control" /></div>
                                </form>
                                <div class="hidden-xs">
                                    <h4 class="mtxl"><strong class="text-uppercase">Email</strong></h4>
                                    <div class="list-group list-group-striped list-group-border">
                                        <div class="list-group-item active"><a href="#" class="block"><i class="fa fa-inbox fa-fw mrs"></i>Inbox</a></div>
                                        <div class="list-group-item"><a href="#" class="block"><i class="fa fa-inbox fa-fw mrs"></i>Sent<div class="pull-right"><span class="badge pink">5</span></div></a></div>
                                        <div class="list-group-item"><a href="#" class="block"><i class="fa fa-pencil fa-fw mrs"></i>Draft</a></div>
                                        <div class="list-group-item"><a href="#" class="block"><i class="fa fa-trash-o fa-fw mrs"></i>Trash<div class="pull-right"><span class="badge badge-warning">20</span></div></a></div>
                                        <div class="list-group-item"><a href="#" class="block"><i class="fa fa-star fa-fw mrs"></i>Archive</a></div>
                                    </div>
                                    <h4 class="mtxl"><strong class="text-uppercase">Folder</strong></h4>
                                    <div class="list-group list-group-striped list-group-border">
                                        <div class="list-group-item"><a href="#" class="block"><i class="fa fa-folder fa-fw mrs"></i>Newsletter</a></div>
                                        <div class="list-group-item"><a href="#" class="block"><i class="fa fa-folder fa-fw mrs"></i>Friend</a></div>
                                        <div class="list-group-item"><a href="#" class="block"><i class="fa fa-folder fa-fw mrs"></i>Company</a></div>
                                        <div class="list-group-item"><a href="#" class="block"><i class="fa fa-folder fa-fw mrs"></i>Downloaded</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-9 col-sm-9">
                                <div class="email-btn-row hidden-xs"><a href="email_compose.html" class="btn btn-sm btn-success"><i class="fa fa-plus mrs"></i>New</a><a href="#" class="btn btn-sm btn-default disabled">Reply</a><a href="#" class="btn btn-sm btn-default disabled">Delete</a><a href="#" class="btn btn-sm btn-default disabled">Archive</a><a href="#" class="btn btn-sm btn-default disabled">Junk</a><a href="#" class="btn btn-sm btn-default disabled">Move to</a><a href="#" class="btn btn-sm btn-default disabled">Categories</a></div>
                                <div class="email-content">
                                    <table class="table table-email">
                                        <thead>
                                            <tr>
                                                <th class="email-select"><input type="checkbox" class="checkall" /></th>
                                                <th colspan="2">
                                                    <div class="dropdown"><a href="#" data-toggle="dropdown" class="email-header-link">View All<i class="fa fa-angle-down mls"></i></a>
                                                        <ul class="dropdown-menu">
                                                ...
                                                <th>
                                                    <div class="dropdown"><a href="#" data-toggle="dropdown" class="email-header-link">Arrange by<i class="fa fa-angle-down mls"></i></a>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="email-select"><input type="checkbox" /></td>
                                                <td class="email-sender">Leap Motion</td>
                                                <td class="email-subject"><a href="#" data-click="email-archive" class="email-btn"><i class="fa fa-folder-open"></i></a><a href="#" data-click="email-remove" class="email-btn"><i class="fa fa-trash-o"></i></a><a href="#" data-click="email-highlight" class="email-btn"><i class="fa fa-flag"></i></a>Maecenas ultrices interdum leo, eu aliquam diam mattis sed.</td>
                                                <td class="email-date">11/4/2014</td>
                                            </tr>
                                            <tr>
                                                <td class="email-select"><input type="checkbox" class="checkall" /></td>
                                                <td class="email-sender">Leap Motion</td>
                                                <td class="email-subject"><a href="#" data-click="email-archive" class="email-btn"><i class="fa fa-folder-open"></i></a><a href="#" data-click="email-remove" class="email-btn"><i class="fa fa-trash-o"></i></a><a href="#" data-click="email-highlight" class="email-btn"><i class="fa fa-flag"></i></a>Ut tristique dapibus nibh, sed scelerisque magna vehicula a.</td>
                                                <td class="email-date">11/4/2014</td>
                                            </tr>
                                            <tr>
                                                <td class="email-select"><input type="checkbox" class="checkall" /></td>
                                                <td class="email-sender">Stefie Chin</td>
                                                <td class="email-subject"><a href="#" data-click="email-archive" class="email-btn"><i class="fa fa-folder-open"></i></a><a href="#" data-click="email-remove" class="email-btn"><i class="fa fa-trash-o"></i></a><a href="#" data-click="email-highlight" class="email-btn"><i class="fa fa-flag"></i></a>Etiam pretium neque vitae vulputate fermentum.</td>
                                                <td class="email-date">11/4/2014</td>
                                            </tr>
                                            <tr>
                                                <td class="email-select"><input type="checkbox" class="checkall" /></td>
                                                <td class="email-sender">Alan Tan</td>
                                                <td class="email-subject"><a href="#" data-click="email-archive" class="email-btn"><i class="fa fa-folder-open"></i></a><a href="#" data-click="email-remove" class="email-btn"><i class="fa fa-trash-o"></i></a><a href="#" data-click="email-highlight" class="email-btn"><i class="fa fa-flag"></i></a>Duis et justo in nisl tristique lobortis id at ligula.</td>
                                                <td class="email-date">11/4/2014</td>
                                            </tr>
                                            <tr>
                                                <td class="email-select"><input type="checkbox" class="checkall" /></td>
                                                <td class="email-sender">Yu Ming Tan</td>
                                                <td class="email-subject"><a href="#" data-click="email-archive" class="email-btn"><i class="fa fa-folder-open"></i></a><a href="#" data-click="email-remove" class="email-btn"><i class="fa fa-trash-o"></i></a><a href="#" data-click="email-highlight" class="email-btn"><i class="fa fa-flag"></i></a>Sed dapibus nec velit eget pulvinar. Etiam id erat in eros imperdiet tempus.</td>
                                                <td class="email-date">11/4/2014</td>
                                            </tr>
                                            <tr>
                                                <td class="email-select"><input type="checkbox" class="checkall" /></td>
                                                <td class="email-sender">Harvinder Signh</td>
                                                <td class="email-subject"><a href="#" data-click="email-archive" class="email-btn"><i class="fa fa-folder-open"></i></a><a href="#" data-click="email-remove" class="email-btn"><i class="fa fa-trash-o"></i></a><a href="#" data-click="email-highlight" class="email-btn"><i class="fa fa-flag"></i></a>Aliquam diam risus, condimentum ut diam in, fermentum euismod sem.</td>
                                                <td class="email-date">12/4/2014</td>
                                            </tr>
                                            <tr>
                                                <td class="email-select"><input type="checkbox" class="checkall" /></td>
                                                <td class="email-sender">Fiona Loh</td>
                                                <td class="email-subject"><a href="#" data-click="email-archive" class="email-btn"><i class="fa fa-folder-open"></i></a><a href="#" data-click="email-remove" class="email-btn"><i class="fa fa-trash-o"></i></a><a href="#" data-click="email-highlight" class="email-btn"><i class="fa fa-flag"></i></a>Praesent dapibus ultricies magna, ac laoreet ante pellentesque nec.</td>
                                                <td class="email-date">11/4/2014</td>
                                            </tr>
                                            <tr>
                                                <td class="email-select"><input type="checkbox" class="checkall" /></td>
                                                <td class="email-sender">Derrick Tew</td>
                                                <td class="email-subject"><a href="#" data-click="email-archive" class="email-btn"><i class="fa fa-folder-open"></i></a><a href="#" data-click="email-remove" class="email-btn"><i class="fa fa-trash-o"></i></a><a href="#" data-click="email-highlight" class="email-btn"><i class="fa fa-flag"></i></a>Nullam eget nibh et dui vestibulum aliquam vitae a lacus.</td>
                                                <td class="email-date">10/4/2014</td>
                                            </tr>
                                            <tr>
                                                <td class="email-select"><input type="checkbox" class="checkall" /></td>
                                                <td class="email-sender">Terry Dew</td>
                                                <td class="email-subject"><a href="#" data-click="email-archive" class="email-btn"><i class="fa fa-folder-open"></i></a><a href="#" data-click="email-remove" class="email-btn"><i class="fa fa-trash-o"></i></a><a href="#" data-click="email-highlight" class="email-btn"><i class="fa fa-flag"></i></a>Nulla eget placerat ante, sed hendrerit felis. Praesent vitae convallis erat.</td>
                                                <td class="email-date">09/4/2014</td>
                                            </tr>
                                            <tr>
                                                <td class="email-select"><input type="checkbox" class="checkall" /></td>
                                                <td class="email-sender">John Doe</td>
                                                <td class="email-subject"><a href="#" data-click="email-archive" class="email-btn"><i class="fa fa-folder-open"></i></a><a href="#" data-click="email-remove" class="email-btn"><i class="fa fa-trash-o"></i></a><a href="#" data-click="email-highlight" class="email-btn"><i class="fa fa-flag"></i></a>Sed dapibus nec velit eget pulvinar. Etiam id erat in eros imperdiet tempus.</td>
                                    ...
                                    <div class="email-footer clearfix">737 messages<ul class="pagination pagination-sm mtn mbn pull-right">
