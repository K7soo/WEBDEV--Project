                        ...
                        <li class="dropdown active"><a href="#" data-hover="dropdown" class="dropdown-toggle"><i
                            ...
                            <ul class="dropdown-menu in">
                                ...
                                <li><a href="page_fullcalendar.html"><span class="submenu-title">Full
                                            Calendar</span></a></li>
                                <li class="active"><a href="page_blank.html"><span
                ...
                <aside class="page-sidebar sidebar-offcanvas">
                    <section class="sidebar">
                        <ul class="sidebar-menu">
                            ...
                            <li class="active"><a href="#"><i class="icon-book-open"></i><span
                                        class="sidebar-text">Pages</span></a>
                                <ul class="nav nav-second-level in">
                                    ...
                                    <li class="active"><a href="page_blank.html">Blank</a></li>
                                    ...
                                    <ul class="admin-setting-list list-unstyled">
                                        <li>
                                            ...
                                            <ul class="option theme-option list-unstyled list-inline">
                                                <li data-color="default" data-hover="tooltip" title="Dark"
                                                    class="dark active">
                                                </li>
                                                <li data-color="blue" data-hover="tooltip" title="Blue" class="blue">
                                                </li>
                                                <li data-color="purple" data-hover="tooltip" title="Purple"
                                                    class="purple"></li>
