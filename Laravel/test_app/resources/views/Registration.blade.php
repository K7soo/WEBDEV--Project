...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="assets/plugins/timepicker/jquery.timepicker.css">
...
<body class="page-header-fixed page-sidebar-fixed">
    <div>
        <div class="page-wrapper"><!--BEGIN HEADER-->
            <header class="header">
                <div class="logo"><a href="index.html" class="logo-text"><i class="ion-ios7-analytics"></i> Rock</a><a href="#" data-toggle="offcanvas" class="sidebar-toggle pull-right"><i class="fa fa-bars"></i></a></div>
            ...
            <div class="page-horizontal-sidebar hide">
                <div id="horizontal-sidebar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown"><a href="#" data-hover="dropdown" class="dropdown-toggle"><i class="icon-notebook"></i><span class="menu-title">Tables</span></a>
                            <ul class="dropdown-menu">
                                <li><a href="table_basic.html"><span class="submenu-title">Basic Tables</span></a></li>
                                <li><a href="table_datatables.html"><span class="submenu-title">DataTables</span></a></li>
                            </ul>
                        </li>
            ...
            <div class="wrapper row-offcanvas row-offcanvas-left"><!--BEGIN SIDEBAR-->
                <aside class="page-sidebar sidebar-offcanvas">
                    <section class="sidebar">
                        <ul class="sidebar-menu">
                            <li><a href="index.html"><i class="icon-home"></i><span class="sidebar-text">Dashboard</span></a></li>
                            <li class="active"><a href="widgets.html"><i class="icon-rocket"></i><span class="sidebar-text">Widgets</span></a></li>
                ...
                <div class="content">
                    <section class="content-header">
                        <h1 class="pull-left">Widgets<small>Header small text goes here...</small></h1>
                    ...
                    <section class="main-content">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong class="text-uppercase text-pink">Add Metting</strong></h3>
                                    </div>
                                    <div class="panel-body form">
                                        <form action="#" class="form-horizontal">
                                            <div class="form-body">
                                                <div class="form-group"><label class="col-md-3 control-label">Name</label>
                                                    <div class="col-md-9"><input type="text" placeholder="Name meeting" class="input-dark form-control" /></div>
                                                </div>
                                                <div class="form-group"><label class="col-md-3 control-label">Date</label>
                                                    <div class="col-md-9">
                                                        <div class="input-group"><input id="date" type="text" value="03/18/2013" class="input-dark form-control" /><span class="input-group-addon no-border"><i class="icon-calendar"></i></span></div>
                                                    </div>
                                                </div>
                                                <div class="form-group"><label class="col-md-3 control-label">Time</label>
                                                    <div class="col-md-9">
                                                        <div class="row">
                                                            <div class="col-md-6"><input type="text" placeholder="12:30 AM" class="timepicker input-dark form-control" /></div>
                                                            <div class="col-md-6"><input type="text" placeholder="01:30 AM" class="timepicker input-dark form-control" /></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group last"><label class="col-md-3 control-label">Members</label>
                                                    <div class="col-md-9"><a href="#" class="mrm"><img src="http://api.randomuser.me/portraits/thumb/men/68.jpg" alt="User Image" width="30px" class="img-circle" /></a><a href="#" class="mrm"><img src="http://api.randomuser.me/portraits/thumb/women/39.jpg" alt="User Image" width="30px" class="img-circle" /></a><a href="#" class="mrm"><img src="http://api.randomuser.me/portraits/thumb/men/60.jpg" alt="User Image" width="30px" class="img-circle" /></a><a href="#"><img src="http://api.randomuser.me/portraits/thumb/women/38.jpg" alt="User Image" width="30px" class="img-circle" /></a></div>
                                                </div>
                                            </div>
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9"><button type="submit" class="btn pink">Submit</button></div>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong class="text-uppercase text-success">Search Flights</strong></h3>
                                    </div>
                                    <div class="panel-body form">
                                        <form action="#">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group"><label class="control-label">From</label><input type="text" placeholder="New York" class="input-dark form-control" /></div>
                                                        <div class="form-group"><label class="control-label">Departure</label>
                                                            <div class="input-group"><input id="departure" type="text" value="03/18/2013" class="input-dark form-control" /><span class="input-group-addon no-border"><i class="icon-calendar"></i></span></div>
                                                        </div>
                                                        <div class="form-group last"><label class="switch switch-purple switch-sm"><input type="radio" name="switch-radio" /><span class="switch"></span><span class="mlm verticle-align-inherit">Round Trip</span></label></div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group"><label class="control-label">Destination</label><input type="text" placeholder="California" class="input-dark form-control" /></div>
                                                        <div class="form-group"><label class="control-label">Return</label>
                                                            <div class="input-group"><input id="return" type="text" value="03/28/2013" class="input-dark form-control" /><span class="input-group-addon no-border"><i class="icon-calendar"></i></span></div>
                                                        </div>
                                                        <div class="form-group last"><label class="switch switch-purple switch-sm"><input type="radio" name="switch-radio" checked="" /><span class="switch"></span><span class="mlm verticle-align-inherit">One Way</span></label></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-6"><button type="submit" class="btn btn-success btn-block">Search</button></div>
                                                    <div class="col-md-6"><button type="button" class="btn btn-default btn-block">Reset</button></div>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="panel">
                                    <div class="panel-body form">
                                        <form action="#">
                                            <div id="form-company-website">
                                                <h4 class="ptl pbl plsm prsm man"><span>Monthly Meeting</span><span class="pull-right"><i class="icon-calendar"></i></span></h4>
                                                <div class="list-group list-group-no-border">
                                                    <div class="list-group-item"><span class="text-muted">Project:</span>&nbsp;<strong>Company Website</strong></div>
                                                    <div class="list-group-item bg-default">
                                                        <p class="date"><strong>May, June 18th</strong></p>
                                                        <p>
                                                        <div class="col-md-6 from pln"><span class="text-muted">Starts at:</span>&nbsp;<strong>19:00</strong></div>
                                                        <div class="col-md-6 to pln"><span class="text-muted">Ends at:</span>&nbsp;<strong>20:00</strong></div>
                                                        </p>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    <div class="list-group-item text-center">
                                                        <p class="ptm man"><span class="text-muted">Participants:</span>&nbsp;<strong>4</strong></p>
                                                        <hr />
                                                        <p class="man"><a href="#" class="mrm"><img src="http://api.randomuser.me/portraits/thumb/men/68.jpg" alt="User Image" width="40px" class="img-circle" /></a><a href="#" class="mrm"><img src="http://api.randomuser.me/portraits/thumb/women/39.jpg" alt="User Image" width="40px" class="img-circle" /></a><a href="#" class="mrm"><img src="http://api.randomuser.me/portraits/thumb/men/60.jpg" alt="User Image" width="40px" class="img-circle" /></a><a href="#"><img src="http://api.randomuser.me/portraits/thumb/women/38.jpg" alt="User Image" width="40px" class="img-circle" /></a></p>
                                                    </div>
                                                    <div class="list-group-item"><a href="#" class="btn btn-primary btn-block">Request an Invitation</a></div>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="panel">
                                    <div class="panel-body form">
                                        <form action="#">
                                            <div id="form-marketing-materials">
                                                <h4 class="ptl pbl plsm prsm man"><span>New Specifications</span><span class="pull-right"><img src="http://api.randomuser.me/portraits/thumb/women/10.jpg" alt="" width="40px" class="avatar img-circle" /></span></h4>
                                                <div class="list-group list-group-no-border">
                                                    <div class="list-group-item"><span class="text-muted">Project:</span>&nbsp;<strong>Marketing Materials</strong></div>
                                                    <div class="list-group-item bg-default">
                                                        <p class="mbn text-muted">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                                                    </div>
                                                    <div class="list-group-item">
                                                        <div class="media"><a href="#" class="pull-left"><img src="http://api.randomuser.me/portraits/thumb/men/60.jpg" alt="User Image" width="40px" class="media-object img-circle" /></a>
                                                            <div class="media-body">
                                                                <h5 class="media-heading">Pascal Aigner</h5><small class="text-muted">Neque porro quisquam est.</small>
                                                            </div>
                                                        </div>
                                                        <div class="media"><a href="#" class="pull-left"><img src="http://api.randomuser.me/portraits/thumb/women/39.jpg" alt="User Image" width="40px" class="media-object img-circle" /></a>
                                                            <div class="media-body">
                                                                <h5 class="media-heading">Paula Aderca</h5><small class="text-muted">Neque porro quisquam est, qui dolorem ipsum quia dolor sit.</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="list-group-item"><input type="text" placeholder="Add a comment..." class="input-dark form-control" /></div>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="panel-body form">
                                        <form action="#">
                                            <div id="form-landing-page">
                                                <h4 class="ptl pbl plsm prsm man"><span>UI of landing page</span><span class="pull-right"><label class="switch switch-success switch-sm"><input type="checkbox" checked="" /><span class="switch"></span></label></span></h4>
                                                <div class="list-group list-group-no-border">
                                                    <div class="list-group-item"><span class="text-muted">Project:</span>&nbsp;<strong>Landing Page</strong></div>
                                                    <div class="list-group-item bg-default">
                                                        <div class="info">
                                                            <div class="col-md-6 priority pln"><span class="text-muted"><i class="fa fa-circle text-warning mrs"></i>Priority:</span>&nbsp;<strong>High</strong></div>
                                                            <div class="col-md-6 due pln"><span class="text-muted">Due:</span>&nbsp;<strong>Today</strong></div>
                                                        </div>
                                                        <p class="mbn text-muted">Excepteur sint occaecat cupidatat.</p>
                                                    </div>
                                                    <div class="list-group-item">
                                                        <div class="media"><a href="#" class="pull-left"><img src="http://api.randomuser.me/portraits/thumb/women/38.jpg" alt="User Image" width="40px" class="media-object img-circle" /></a>
                                                            <div class="media-body">
                                                                <h5 class="media-heading">Alice Walker</h5><small class="text-muted">Neque porro quisquam est.</small>
                                                            </div>
                                                        </div>
                                                        <div class="media"><a href="#" class="pull-left"><img src="http://api.randomuser.me/portraits/thumb/men/59.jpg" alt="User Image" width="40px" class="media-object img-circle" /></a>
                                                            <div class="media-body">
                                                                <h5 class="media-heading">John David</h5><small class="text-muted">Neque porro quisquam est, qui dolorem ipsum quia dolor sit.</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="list-group-item"><input type="text" placeholder="Add a comment..." class="input-dark form-control" /></div>
                            ...
                            <div class="col-md-3">
                                <div class="panel">
                                    <div class="panel-body form">
                                        <form action="#">
                                            <div id="form-users">
                                                <h4 class="ptl pbl plsm prsm man"><input type="text" placeholder="Search a member..." class="input-dark input-lg form-control" /></h4>
                                                <div class="list-group list-group-no-border">
                                                    <div class="list-group-item">
                                                        <div class="media"><a href="#" class="avatar pull-left"><img src="http://api.randomuser.me/portraits/thumb/men/60.jpg" alt="User Image" width="40px" class="media-object img-circle" /><i class="busy"></i></a>
                                                            <div class="media-body">
                                                                <h5 class="media-heading">John David</h5><small class="text-muted">CEO, Founder</small>
                                                                <div class="actions"><a href="javascript:;" class="edit"><i class="icon-pencil"></i></a><a href="javascript:;" class="delete"><i class="icon-close"></i></a></div>
                                                            </div>
                                                        </div>
                                                        <div class="media"><a href="#" class="avatar pull-left"><img src="http://api.randomuser.me/portraits/thumb/women/39.jpg" alt="User Image" width="40px" class="media-object img-circle" /><i class="online"></i></a>
                                                            <div class="media-body">
                                                                <h5 class="media-heading">Julia Howell</h5><small class="text-muted">Project Manager</small>
                                                                <div class="actions"><a href="javascript:;" class="edit"><i class="icon-pencil"></i></a><a href="javascript:;" class="delete"><i class="icon-close"></i></a></div>
                                                            </div>
                                                        </div>
                                                        <div class="media"><a href="#" class="avatar pull-left"><img src="http://api.randomuser.me/portraits/thumb/men/59.jpg" alt="User Image" width="40px" class="media-object img-circle" /><i class="busy"></i></a>
                                                            <div class="media-body">
                                                                <h5 class="media-heading">Arthur Wong</h5><small class="text-muted">Developer</small>
                                                                <div class="actions"><a href="javascript:;" class="edit"><i class="icon-pencil"></i></a><a href="javascript:;" class="delete"><i class="icon-close"></i></a></div>
                                                            </div>
                                                        </div>
                                                        <div class="media"><a href="#" class="avatar pull-left"><img src="http://api.randomuser.me/portraits/thumb/women/37.jpg" alt="User Image" width="40px" class="media-object img-circle" /><i class="idle"></i></a>
                                                            <div class="media-body">
                                                                <h5 class="media-heading">Amy Perry</h5><small class="text-muted">Frontend Designer</small>
                                                                <div class="actions"><a href="javascript:;" class="edit"><i class="icon-pencil"></i></a><a href="javascript:;" class="delete"><i class="icon-close"></i></a></div>
                                                            </div>
                                                        </div>
                                                        <div class="media"><a href="#" class="avatar pull-left"><img src="http://api.randomuser.me/portraits/thumb/men/57.jpg" alt="User Image" width="40px" class="media-object img-circle" /><i class="online"></i></a>
                                                            <div class="media-body">
                                                                <h5 class="media-heading">Brian Pierce</h5><small class="text-muted">Backend Designer</small>
                                                                <div class="actions"><a href="javascript:;" class="edit"><i class="icon-pencil"></i></a><a href="javascript:;" class="delete"><i class="icon-close"></i></a></div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong class="text-uppercase text-pink">Follower</strong></h3>
                                    </div>
                                    <div class="panel-body">
                                        <table class="table table-striped table-no-border mtm mbn">
                                            <thead>
                                                <tr>
                                                    <th>Avatar</th>
                                                    <th>Full Name</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img src="http://api.randomuser.me/portraits/thumb/men/68.jpg" alt="" width="36px" class="img-responsive img-circle" /></td>
                                                    <td>Teodor Macri</td>
                                                    <td>teodor@example.com</td>
                                                    <td><a href="#" class="btn btn-success btn-sm"><i class="fa fa-check"></i>&nbsp;<span>Following</span></a></td>
                                                </tr>
                                                <tr>
                                                    <td><img src="http://api.randomuser.me/portraits/thumb/women/39.jpg" alt="" width="36px" class="img-responsive img-circle" /></td>
                                                    <td>Paula Aderca</td>
                                                    <td>paula@example.com</td>
                                                    <td><a href="#" class="btn white btn-sm"><span>Follow</span></a></td>
                                                </tr>
                                                <tr>
                                                    <td><img src="http://api.randomuser.me/portraits/thumb/men/60.jpg" alt="" width="36px" class="img-responsive img-circle" /></td>
                                                    <td>Pascal Aigner</td>
                                                    <td>pascal@example.com</td>
                                                    <td><a href="#" class="btn white btn-sm"><span>Follow</span></a></td>
                                                </tr>
                                                <tr>
                                                    <td><img src="http://api.randomuser.me/portraits/thumb/women/38.jpg" alt="" width="36px" class="img-responsive img-circle" /></td>
                                                    <td>Alice Walker</td>
                                                    <td>alice@example.com</td>
                                                    <td><a href="#" class="btn white btn-sm"><span>Follow</span></a></td>
                                                </tr>
                                                <tr>
                                                    <td><img src="http://api.randomuser.me/portraits/thumb/women/10.jpg" alt="" width="36px" class="img-responsive img-circle" /></td>
                                                    <td>Isabelle Johnson</td>
                                                    <td>isabelle@example.com</td>
                                                    <td><a href="#" class="btn btn-success btn-sm"><i class="fa fa-check"></i>&nbsp;<span>Following</span></a></td>
                                                </tr>
                                                <tr>
                                                    <td><img src="http://api.randomuser.me/portraits/thumb/men/60.jpg" alt="" width="36px" class="img-responsive img-circle" /></td>
                            ...
                            <div class="col-md-6">
                                <div class="panel widget-chats">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong class="text-uppercase text-pink">Chats</strong></h3>
                                    </div>
                                    <div class="panel-body form">
                                        <form action="#">
                                            <div class="form-chat mtl">
                                                <div class="chat-scroll">
                                                    <ul class="chats">
                                                        <li class="in"><img src="http://api.randomuser.me/portraits/thumb/women/38.jpg" class="avatar img-responsive" />
                                                            <div class="message"><span class="chat-arrow"></span><a href="#" class="chat-name">Alice Walker</a><span class="chat-datetime">at Oct 10, 2014 18:16</span><span class="chat-body">Hi, you there?</span></div>
                                                        </li>
                                                        <li class="out"><img src="http://api.randomuser.me/portraits/thumb/men/60.jpg" class="avatar img-responsive" />
                                                            <div class="message"><span class="chat-arrow"></span><a href="#" class="chat-name">Pascal Aigner</a><span class="chat-datetime">at Oct 10, 2014 18:17</span><span class="chat-body">Want to meet later?</span></div>
                                                        </li>
                                                        <li class="in"><img src="http://api.randomuser.me/portraits/thumb/women/38.jpg" class="avatar img-responsive" />
                                                            <div class="message"><span class="chat-arrow"></span><a href="#" class="chat-name">Alice Walker</a><span class="chat-datetime">at Oct 10, 2014 18:20</span><span class="chat-body">Sure, what time?</span></div>
                                                        </li>
                                                        <li class="out"><img src="http://api.randomuser.me/portraits/thumb/men/60.jpg" class="avatar img-responsive" />
                                                            <div class="message"><span class="chat-arrow"></span><a href="#" class="chat-name">Pascal Aigner</a><span class="chat-datetime">at Oct 10, 2014 18:23</span><span class="chat-body">20:00?</span></div>
                                                        </li>
                                                        <li class="in"><img src="http://api.randomuser.me/portraits/thumb/women/38.jpg" class="avatar img-responsive" />
                                                            <div class="message"><span class="chat-arrow"></span><a href="#" class="chat-name">Alice Walker</a><span class="chat-datetime">at Oct 10, 2014 18:25</span><span class="chat-body">Sounds good. See you then.</span></div>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="panel-footer bg-white"><textarea rows="2" placeholder="Enter a message..." class="input-dark form-control mtm mbm"></textarea></div>
                                </div>
                            </div>
                        </div>
                    </section>
    ...
    <script src="assets/plugins/timepicker/jquery.timepicker.min.js"></script>
